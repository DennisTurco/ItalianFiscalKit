...
// Invalid cases
IBANValidator.IsValid("");                              // empty
IBANValidator.IsValid("IT00X0542811101000000123456");   // bad mod-97 checksum
IBANValidator.IsValid("XX60X0542811101000000123456");   // unknown country XX
IBANValidator.IsValid("US60X0542811101000000123456");   // non-SEPA country
IBANValidator.IsValid("IT60X054281110100000012345");    // wrong length (26 instead of 27)
```
