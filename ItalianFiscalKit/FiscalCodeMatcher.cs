...
/// <summary>
/// Provides methods to match and compare Italian Fiscal Code strings against personal data.
/// </summary>
public class FiscalCodeMatcher
{
    /// <summary>
    /// Determines whether the specified Fiscal Code matches the provided personal data.
    /// The comparison is case-insensitive. Omocodia variants of the CF are normalized before
    /// comparison.
    /// </summary>
    /// <param name="cf">The Fiscal Code to check.</param>
    ...
    /// <returns>
    /// <c>true</c> if the Fiscal Code is valid and matches the generated CF for the
